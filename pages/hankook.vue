    ...
    <span>
        <div class="page-header header-filter header-small" data-parallax="true" style=" background-image: url('/img/kit/pro/car2.jpg'); ">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="/img/Hankook_TireLogo.png" alt="" width="350">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12 ml-auto mr-auto text-center">
                            <ul class="nav nav-pills nav-pills-warning">
                                ...
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(2)' :class="[AboutContinental == true ? 'active show' : '']" class="nav-link" href="#pillAbout" data-toggle="tab">About Hankook</a>
                                </li>
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(3)' :class="[WhyContinental == true ? 'active show' : '']" class="nav-link" href="#pillWhy" data-toggle="tab">Why Hankook tyres</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 ml-auto mr-auto">
                            <div class="tab-content tab-space">
                                <template v-if="AvailablePatterns">
                                    ...
                                    <template v-else>
                                        <h3 class="mt-0 mb-1 title text-warning text-center">Hankook Patterns</h3>
                                        <div class="row">
                                                        ...
                                                        <div class="col-md-3 animated bounceIn" v-for="uni in uniqueConti" :key="uni.id">
                                                            <div class="card card-profile card-plain">
                                                                ...
                                                                <div class="card-body mt-0">
                                                                    ...
                                                                    <nuxt-link :to="{ name: 'hankookpattern-pattern', params: {pattern:uni.pattern} }" class="selecttyre btn btn-sm btn-primary btn-link float-center">
                                                                        Read more
                                                                    </nuxt-link>
                                                                </div>
                                                            </div>
                                                ...
                                                <template v-if="fours">
                                                    <div class="col-md-3 animated bounceIn" v-for="uni in fourbyfour" :key="uni.id">
                                                        <div class="card card-profile card-plain">
                                                            ...
                                                            <div class="card-body mt-0">
                                                                <nuxt-link :to="{ name: 'hankookpattern-pattern', params: {pattern:uni.pattern} }">
                                                                    <h4 class="card-title my-0">{{uni.pattern}}</h4>
                                                                </nuxt-link>
                                                                <nuxt-link :to="{ name: 'hankookpattern-pattern', params: {pattern:uni.pattern} }" class="selecttyre btn btn-sm btn-primary btn-link float-center">
                                                                    Read more
                                ...
                                <template v-if="AboutContinental">
                                    <h3 class="title text-warning text-center m-0">About Hankook.</h3>
                                    <div class="row">
                                        <div class="col-md-6 mr-auto ml-auto">
                                            <vue-plyr>
                                                <video poster="/img/hankook1.png" src="/img/Hankooknew.mp4">
                                                    <source src="/img/Hankooknew.mp4" type="Hankooknew/mp4" size="720">
                                                    <source src="/img/Hankooknew.mp4" type="Hankooknew/mp4" size="1080">
                                                </video>
                                            </vue-plyr>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" v-for="dt in abouthankook" :key="dt.id">
                                        <div class="col-md-10 mx-auto my-5">
                                            <p class="text-dark" v-for="whdt in dt.writeup" :key="whdt.id">
                                                {{whdt.para}}
                                            </p>
                                        </div>

                                        <div class="col-md-8 mx-auto" v-for="sbdt in dt.fulldesc" :key="sbdt.id">
                                        ...
                                        <h4 class="text-center">{{dt.subdesc}}</h4>
                                        <div class="row">
                                            <div class="col-md-12">
                                ...
                                <template v-if="WhyContinental">
                                    <h3 class="mt-0 title text-warning text-center">Why Hankook tyres</h3>
                                    <div class="related-products" v-for="why in whyhankook" :key="why.id">
                                            ...
                                            <div class="col-sm-6 col-md-4" v-for="pt in why.keypoints" :key="pt.id">
                                                <div class="card card-product">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h6 class="card-category text-warning text-left">{{pt.subtitle}}</h6>
                                                        <div class="card-description text-left text-dark">
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            abouthankook: 'hankookdata/abouthankook',
            whyhankook: 'hankookdata/whyhankook',
            ...
            selectfeature: 'hankookfeatures/selectfeature'
        }),
        fourbyfour: function(){
            var fourbyfour = [];
    ...
    methods: {
        ...mapActions({
            ...
            setSelectPattaern: 'hankookfeatures/setSelectPattaern',
            clearSelectFeatursDetail: 'hankookfeatures/clearSelectFeaturs',
        }),
        ...
        brandWidthCallback(event){
            if (event.target.value != null) {
                ...
                this.getBrandWidth({'brand':'HANKOOK', 'width': event.target.value})
            }
        },
        brandRatioCallback(event){
            if (event.target.value != null) {
                ...
                this.getBrandRatio({'brand':'HANKOOK', 'width':this.selectbrandwidth, 'ratio':event.target.value})
            }
        },
        brandDiameterCallback(event){
            if (event.target.value != null) {
                this.searchingbrand = true
                this.clearbranddata()
                this.getBrandAlldata({'brand':'HANKOOK', 'width':this.selectbrandwidth, 'ratio':this.selectbrandratio, 'diameter':event.target.value})
    ...
    mounted() {
        ...
        if (this.$route.name == 'hankook') {
            this.clearbranddata()
            this.setUniqueConti("HANKOOK");
            this.setUniqueBrandWidth("HANKOOK");
        }
        this.AvailablePatterns = true
        this.fours=true
    },
