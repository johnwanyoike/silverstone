    ...
    <span>
        <div class="page-header header-filter header-small" data-parallax="true" style=" background-image: url('/img/kit/pro/car2.jpg'); ">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="/img/client-15.png" alt="" width="350">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12 ml-auto mr-auto text-center">
                            <ul class="nav nav-pills nav-pills-danger">
                                ...
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(2)' :class="[AboutContinental == true ? 'active show' : '']" class="nav-link" href="#pillAbout" data-toggle="tab">About Zeta</a>
                                </li>
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(3)' :class="[WhyContinental == true ? 'active show' : '']" class="nav-link" href="#pillWhy" data-toggle="tab">Why Zeta tyres</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 ml-auto mr-auto">
                            <div class="tab-content tab-space">
                                <template v-if="AvailablePatterns">
                                    ...
                                    <template v-else>
                                        <h3 class="mt-0 mb-1 title text-danger text-center">Zeta Patterns</h3>
                                        <div class="row">
                                                        ...
                                                        <div class="col-md-3 animated bounceIn" v-for="uni in uniqueConti" :key="uni.id">
                                                            <div class="card card-profile card-plain">
                                                                ...
                                                                <div class="card-body mt-0">
                                                                    <nuxt-link :to="{ name: 'zetapattern-pattern', params: {pattern:uni.pattern} }">
                                                                        <h4 class="card-title my-0">{{uni.pattern}}</h4>
                                                                    </nuxt-link>
                                                                    <nuxt-link :to="{ name: 'zetapattern-pattern', params: {pattern:uni.pattern} }" class="selecttyre btn btn-sm btn-primary btn-link float-center">
                                                                        Read more
                                                                    </nuxt-link>
                                                                </div>
                                                            </div>
                                ...
                                <template v-if="AboutContinental">
                                    <h3 class="title text-danger text-center m-0">About Zeta.</h3>
                                    <div class="row" v-for="dt in aboutzeta" :key="dt.id">
                                ...
                                <template v-if="WhyContinental">
                                    <h3 class="mt-0 title text-danger text-center">Why Zeta tyres</h3>
                                    <div class="related-products" v-for="why in whyzeta" :key="why.id">
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            aboutzeta: 'zetadata/aboutzeta',
            whyzeta: 'zetadata/whyzeta',
            ...
            selectfeature: 'zetafeatures/selectfeature'
        }),
        fourbyfour: function(){
            var fourbyfour = [];
    ...
    methods: {
        ...mapActions({
            ...
            setSelectPattaern: 'zetafeatures/setSelectPattaern',
            clearSelectFeatursDetail: 'zetafeatures/clearSelectFeaturs',
        }),
        ...
        brandWidthCallback(event){
            if (event.target.value != null) {
                ...
                this.getBrandWidth({'brand':'ZETA', 'width': event.target.value})
            }
        },
        brandRatioCallback(event){
            if (event.target.value != null) {
                ...
                this.getBrandRatio({'brand':'ZETA', 'width':this.selectbrandwidth, 'ratio':event.target.value})
            }
        },
        brandDiameterCallback(event){
            if (event.target.value != null) {
                this.searchingbrand = true
                this.clearbranddata()
                this.getBrandAlldata({'brand':'ZETA', 'width':this.selectbrandwidth, 'ratio':this.selectbrandratio, 'diameter':event.target.value})
    ...
    mounted() {
        ...
        if (this.$route.name == 'zeta') {
            this.clearbranddata()
            this.setUniqueConti("ZETA");
            this.setUniqueBrandWidth("ZETA");
        }
        this.AvailablePatterns = true
        this.fours=true
    },
