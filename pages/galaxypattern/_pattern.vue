                    ...
                    <div class="row">
                        <div class="col-md-12 ml-auto mr-auto">
                            ...
                            <div class="follow" style="position: absolute; top: -25px; right: 80px;">
                                <nuxt-link :to="{ name: 'galaxy', params: {brand:'GALAXY'} }" class="btn mr-5 btn-fab btn-info btn-round">
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            selectfeature: 'galaxyfeatures/selectfeature',
    ...
    methods: {
        ...mapActions({
            ...
            setSelectPattaern: 'galaxyfeatures/setSelectPattaern',
            getselectsinglepattern: 'getselectsinglepattern',
            clearSelectFeaturs: 'clearSelectFeaturs',
            clearSelectFeatursDetail: 'galaxyfeatures/clearSelectFeaturs',
        }),
    },
    mounted() {
