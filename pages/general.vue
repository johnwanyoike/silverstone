    ...
    <span>
        <div class="page-header header-filter header-small" data-parallax="true" style=" background-image: url('/img/kit/pro/car2.jpg'); ">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="/img/gentirelogo.png" alt="" width="350">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12 ml-auto mr-auto text-center">
                            <ul class="nav nav-pills nav-pills-danger">
                                ...
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(2)' :class="[AboutContinental == true ? 'active show' : '']" class="nav-link" href="#pillAbout" data-toggle="tab">About General</a>
                                </li>
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(3)' :class="[WhyContinental == true ? 'active show' : '']" class="nav-link" href="#pillWhy" data-toggle="tab">Why General tyres</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 ml-auto mr-auto">
                            <div class="tab-content tab-space">
                                <template v-if="AvailablePatterns">
                                    ...
                                    <template v-else>
                                        <h3 class="mt-0 mb-1 title text-danger text-center">General Patterns</h3>
                                        <div class="row">
                                                        ...
                                                        <div class="col-md-3 animated bounceIn" v-for="uni in uniqueConti" :key="uni.id">
                                                            <div class="card card-profile card-plain">
                                                                ...
                                                                <div class="card-body mt-0">
                                                                    ...
                                                                    <nuxt-link :to="{ name: 'generalpattern-pattern', params: {pattern:uni.pattern} }" class="selecttyre btn btn-sm btn-primary btn-link float-center">
                                                                        Read more
                                                                    </nuxt-link>
                                                                </div>
                                                            </div>
                                                ...
                                                <template v-if="fours">
                                                    <div class="col-md-3 animated bounceIn" v-for="uni in fourbyfour" :key="uni.id">
                                                        <div class="card card-profile card-plain">
                                                            ...
                                                            <div class="card-body mt-0">
                                                                <nuxt-link :to="{ name: 'generalpattern-pattern', params: {pattern:uni.pattern} }">
                                                                    <h4 class="card-title my-0">{{uni.pattern}}</h4>
                                                                </nuxt-link>
                                                                <nuxt-link :to="{ name: 'generalpattern-pattern', params: {pattern:uni.pattern} }" class="selecttyre btn btn-sm btn-primary btn-link float-center">
                                                                    Read more
                                ...
                                <template v-if="AboutContinental">
                                    <h3 class="title text-danger text-center m-0">About General.</h3>
                                    <div class="row">
                                        <div class="col-md-6 mr-auto ml-auto">
                                            <vue-plyr>
                                                <video poster="/img/general.png" src="/img/general.mp4">
                                                    <source src="/img/general.mp4" type="video/mp4" size="720">
                                                    <source src="/img/general.mp4" type="video/mp4" size="1080">
                                                </video>
                                            </vue-plyr>
                                        </div>
                                    </div>
                                ...
                                <template v-if="WhyContinental">
                                    <h3 class="mt-0 title text-danger text-center">Why General tyres</h3>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            aboutgeneral: 'generaldata/aboutgeneral',
            whygeneral: 'generaldata/whygeneral',
    ...
    mounted() {
        ...
        if (this.$route.name == 'general') {
            this.clearbranddata()
            this.setUniqueConti("GENERAL");
            this.setUniqueBrandWidth("GENERAL");
        }
        this.AvailablePatterns = true
        this.fours=true
    },
