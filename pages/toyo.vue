    ...
    <span>
        <div class="page-header header-filter header-small" data-parallax="true" style=" background-image: url('/img/kit/pro/car2.jpg'); ">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="/img/Toyo new logo.png" alt="" width="350">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12 ml-auto mr-auto text-center">
                            <ul class="nav nav-pills nav-pills-info">
                                ...
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(2)' :class="[AboutContinental == true ? 'active show' : '']" class="nav-link" href="#pillAbout" data-toggle="tab">About Toyo</a>
                                </li>
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(3)' :class="[WhyContinental == true ? 'active show' : '']" class="nav-link" href="#pillWhy" data-toggle="tab">Why Toyo tyres</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 ml-auto mr-auto">
                            <div class="tab-content tab-space">
                                <template v-if="AvailablePatterns">
                                    ...
                                    <template v-else>
                                        <h3 class="mt-0 mb-1 title text-info text-center">Toyo Patterns</h3>
                                        <div class="row">
                                                ...
                                                <template v-if="fours">
                                                    <div class="col-md-3 animated bounceIn" v-for="uni in fourbyfour" :key="uni.id">
                                                        ...
                                                        <div class="card card-profile card-plain">
                                                            ...
                                                            <div class="card-body mt-0">
                                                                <nuxt-link :to="{ name: 'toyopattern-pattern', params: {pattern:uni.pattern} }">
                                                                    <h4 class="card-title my-0">{{uni.pattern}}</h4>
                                                                </nuxt-link>
                                                                <nuxt-link :to="{ name: 'toyopattern-pattern', params: {pattern:uni.pattern} }" class="selecttyre btn btn-sm btn-primary btn-link float-center">
                                                                    Read more
                                                                </nuxt-link>
                                                            </div>
                                                        </div>
                                ...
                                <template v-if="AboutContinental">
                                    <h3 class="title text-info text-center m-0">About Toyo.</h3>
                                    <div class="row">
                                        <div class="col-md-6 mr-auto ml-auto">
                                            <vue-plyr>
                                                <video poster="/img/poster.png" src="/img/video.mp4">
                                                    <source src="/img/video.mp4" type="video/mp4" size="720">
                                                    <source src="/img/video.mp4" type="video/mp4" size="1080">
                                                </video>
                                            </vue-plyr>
                                        </div>
                                        ...
                                        <div class="col-md-6 mr-auto ml-auto">
                                            <vue-plyr>
                                                <video poster="/img/poster.png" src="/img/Toyovideo.mp4">
                                                    <source src="/img/Toyovideo.mp4" type="video/mp4" size="720">
                                                    <source src="/img/Toyovideo.mp4" type="video/mp4" size="1080">
                                                </video>
                                            </vue-plyr>
                                        </div>

                                    </div>
                                    <div class="row" v-for="dt in abouttoyo" :key="dt.id">
                                        <div class="col-md-4" v-for="sbdt in dt.fulldesc" :key="sbdt.id">
                                            <div class="info">
                                                <h4 class="info-title text-center"><i class="material-icons text-info">verified_user</i></h4>
                                                <p class="text-dark">{{sbdt.para}}</p>
                                            </div>
                                        </div>
                                        <div class="col-md-12 text-center">
                                            <h4 class="title">{{dt.subdesc}}</h4>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <footer class="footer footer-big animated zoomIn faster">
                                                    <div class="container">
                                                        <div class="content">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="social-feed">
                                                                        <div class="feed-line" v-for="adv in dt.advantages" :key="adv.id">
                                                                            <i class="material-icons text-success">check</i>
                                                                            <p class="text-dark" style="max-width: none;">{{adv.para}}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                ...
                                <template v-if="WhyContinental">
                                    <h3 class="mt-0 title text-info text-center">Why Toyo tyres</h3>
                                    <div class="related-products" v-for="why in whytoyo" :key="why.id">

                                        <div class="col-md-12 mb-5">
                                            <p class="text-dark" v-for="whdt in why.writeup" :key="whdt.id">
                                                {{whdt.para}}
                                            </p>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6" v-for="pt in why.keypoints" :key="pt.id">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <h4 class="media-heading">{{pt.title}}</h4>
                                                        <p class="text-dark">{{pt.para}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            abouttoyo: 'toyodata/abouttoyo',
            whytoyo: 'toyodata/whytoyo',
            ...
            selectfeature: 'toyofeatures/selectfeature'
        }),
        fourbyfour: function(){
            var fourbyfour = [];
    ...
    methods: {
        ...mapActions({
            ...
            setSelectPattaern: 'toyofeatures/setSelectPattaern',
            clearSelectFeatursDetail: 'toyofeatures/clearSelectFeaturs',
        }),
        ...
        brandWidthCallback(event){
            if (event.target.value != null) {
                ...
                this.getBrandWidth({'brand':'TOYO', 'width': event.target.value})
            }
        },
        brandRatioCallback(event){
            if (event.target.value != null) {
                ...
                this.getBrandRatio({'brand':'TOYO', 'width':this.selectbrandwidth, 'ratio':event.target.value})
            }
        },
        brandDiameterCallback(event){
            if (event.target.value != null) {
                this.searchingbrand = true
                this.clearbranddata()
                this.getBrandAlldata({'brand':'TOYO', 'width':this.selectbrandwidth, 'ratio':this.selectbrandratio, 'diameter':event.target.value})
    ...
    mounted() {
        ...
        if (this.$route.name == 'toyo') {
            this.clearbranddata()
            this.setUniqueConti("TOYO");
            this.setUniqueBrandWidth("TOYO");
        }
        this.AvailablePatterns = true
        this.fours=true
    },
