                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12 ml-auto mr-auto text-center">
                            <ul class="nav nav-pills nav-pills-info">
                                ...
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(2)' :class="[AboutContinental == true ? 'active show' : '']" class="nav-link" href="#pillAbout" data-toggle="tab">About Sailun</a>
                                </li>
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(3)' :class="[WhyContinental == true ? 'active show' : '']" class="nav-link" href="#pillWhy" data-toggle="tab">Why Sailun tyres</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 ml-auto mr-auto">
                            <div class="tab-content tab-space">
                                <template v-if="AvailablePatterns">
                                    ...
                                    <template v-else>
                                        <h3 class="mt-0 mb-1 title text-info text-center">Sailun Patterns</h3>
                                        <div class="row">
                                                ...
                                                <template v-if="fours">
                                                    <div class="col-md-3 animated bounceIn" v-for="uni in fourbyfour" :key="uni.id">
                                                        <div class="card card-profile card-plain">
                                                            ...
                                                            <div class="card-body mt-0">
                                                                <nuxt-link :to="{ name: 'sailunpattern-pattern', params: {pattern:uni.pattern} }">
                                                                    <h4 class="card-title my-0">{{uni.pattern}}</h4>
                                                                </nuxt-link>
                                                                <nuxt-link :to="{ name: 'sailunpattern-pattern', params: {pattern:uni.pattern} }" class="selecttyre btn btn-sm btn-primary btn-link float-center">
                                                                    Read more
                                                                </nuxt-link>
                                                            </div>
                                                        </div>
                                ...
                                <template v-if="AboutContinental">
                                    <h3 class="title text-info text-center m-0">About Sailun.</h3>

                                    <div class="row">
                                        <div class="col-md-6 mr-auto ml-auto">
                                            <vue-plyr>
                                                <video poster="/img/sailun.png" src="/img/sailunvideo.mp4">
                                                    <source src="/img/sailunvideo.mp4" type="sailunvideo/mp4" size="720">
                                                    <source src="/img/sailunvideo.mp4" type="sailunvideo/mp4" size="1080">
                                                </video>
                                            </vue-plyr>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" v-for="dt in aboutsailun" :key="dt.id">
                                ...
                                <template v-if="WhyContinental">
                                    <h3 class="mt-0 title text-info text-center">Why Sailun tyres</h3>
                                    <div class="related-products" v-for="why in whysailun" :key="why.id">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6" v-for="pt in why.keypoints" :key="pt.id">
                                                <div class="card card-product">
                                                    <div class="card-body">
                                                        <h4 class="card-title text-left">{{pt.title}}</h4>
                                                        <div class="card-description text-left">
                                                            <p class="text-dark" v-for="st in pt.data" :key="st.id">{{st.para}}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            aboutsailun: 'sailundata/aboutsailun',
            whysailun: 'sailundata/whysailun',
            ...
            selectfeature: 'sailunfeatures/selectfeature'
        }),
        fourbyfour: function(){
            var fourbyfour = [];
    ...
    methods: {
        ...mapActions({
            ...
            setSelectPattaern: 'sailunfeatures/setSelectPattaern',
            clearSelectFeatursDetail: 'sailunfeatures/clearSelectFeaturs',
        }),
        ...
        brandWidthCallback(event){
            if (event.target.value != null) {
                ...
                this.getBrandWidth({'brand':'SAILUN', 'width': event.target.value})
            }
        },
        brandRatioCallback(event){
            if (event.target.value != null) {
                ...
                this.getBrandRatio({'brand':'SAILUN', 'width':this.selectbrandwidth, 'ratio':event.target.value})
            }
        },
        brandDiameterCallback(event){
            if (event.target.value != null) {
                this.searchingbrand = true
                this.clearbranddata()
                this.getBrandAlldata({'brand':'SAILUN', 'width':this.selectbrandwidth, 'ratio':this.selectbrandratio, 'diameter':event.target.value})
    ...
    mounted() {
        ...
        if (this.$route.name == 'sailun') {
            this.clearbranddata()
            this.setUniqueConti("SAILUN");
            this.setUniqueBrandWidth("SAILUN");
        }
        this.AvailablePatterns = true
        this.fours=true
    },
