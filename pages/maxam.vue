    ...
    <span>
        <div class="page-header header-filter header-small" data-parallax="true" style=" background-image: url('/img/kit/pro/car2.jpg'); ">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="/img/Maxamlogo.png" alt="" width="400">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12 ml-auto mr-auto text-center">
                            <ul class="nav nav-pills nav-pills-danger">
                                ...
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(2)' :class="[AboutContinental == true ? 'active show' : '']" class="nav-link" href="#pillAbout" data-toggle="tab">About Maxam</a>
                                </li>
                                <li class="nav-item mr-auto ml-auto">
                                    <a style="font-size: 14px;" @click.prevent='servicedata(3)' :class="[WhyContinental == true ? 'active show' : '']" class="nav-link" href="#pillWhy" data-toggle="tab">Why Maxam tyres</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 ml-auto mr-auto">
                            <div class="tab-content tab-space">
                                <template v-if="AvailablePatterns">
                                    ...
                                    <template v-else>
                                        <h3 class="mt-0 mb-1 title text-danger text-center">Maxam Patterns</h3>
                                        <!-- <div class="row">
                                                        ...
                                                        <div class="col-md-3 animated bounceIn" v-for="uni in uniqueConti" :key="uni.id">
                                                            <div class="card card-profile card-plain">
                                                                ...
                                                                <div class="card-body mt-0">
                                                                    <nuxt-link :to="{ name: 'maxampattern-pattern', params: {pattern:uni.pattern} }">
                                                                        <h4 class="card-title my-0">{{uni.pattern}}</h4>
                                                                    </nuxt-link>
                                                                    <nuxt-link :to="{ name: 'maxampattern-pattern', params: {pattern:uni.pattern} }" class="selecttyre btn btn-sm btn-primary btn-link float-center">
                                                                        Read more
                                                                    </nuxt-link>
                                                                </div>
                                                            </div>
                                ...
                                <template v-if="AboutContinental">
                                    <h3 class="title text-danger text-center m-0">About Maxam.</h3>
                                    <div class="row" v-for="dt in aboutmaxam" :key="dt.id">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-raised card-background py-2" style="background: url('/img/galaxy.png')">
                                            <div class="card-body">
                                                <h3 class="card-title">Download Maxam technical catalogue</h3>
                                                <a href="/img/MaxamCatalog.pdf" target="_blank" class="btn btn-warning btn-round mt-5">
                                ...
                                <template v-if="WhyContinental">
                                    <h3 class="mt-0 title text-danger text-center">Why Maxam tyres</h3>
                                    <div class="related-products" v-for="why in whymaxam" :key="why.id">
...
export default {
    ...
    computed: {
        ...mapGetters({
            ...
            aboutmaxam: 'maxamdata/aboutmaxam',
            whymaxam: 'maxamdata/whymaxam',
    ...
    mounted() {
        ...
        if (this.$route.name == 'maxam') {
            this.clearbranddata()
            this.setUniqueConti("MAXAM");
            this.setUniqueBrandWidth("MAXAM");
        }
        this.AvailablePatterns = true
        this.fours=true
    },
